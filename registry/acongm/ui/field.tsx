...
export function FieldDescription({
  ...
  return (
    <p
      ...
      className={cn(
        "text-sm font-normal leading-normal text-muted-foreground group-has-data-horizontal/field:text-balance [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary",
        className,
      )}
      {...props}
    />
